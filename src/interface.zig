...
pub extern fn drawImage(path: [*]const u8, sx: f32, sy: f32, sw: f32, sh: f32, dx: f32, dy: f32, dw: f32, dh: f32, x_flipped: bool, y_flipped: bool, rotation: f32) void;
pub extern fn loadSpriteMap(path: [*]const u8) void;
